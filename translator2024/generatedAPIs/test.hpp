...
#define CAN_DLC_Telemetry_AltitudeAndSatellites 5
	struct Telemetry::AltitudeAndSatellites {
		float GpsAltitude;
...
#define CAN_DLC_Telemetry_SystemStatusMessages 8
	struct Telemetry::SystemStatusMessages {
		uint8_t Power;
		uint8_t WritingToSd;
...
#define CAN_DLC_Testbed_TestbedEnvirocanIno 8
	struct Testbed::TestbedEnvirocanIno {
		float TempDegC;
		float Humidity;
	} __attribute__((aligned(8)));
	#endif
...
#define CAN_DLC_DriverControls_SpeedValCurrVal 8
	struct DriverControls::SpeedValCurrVal {
...
#define CAN_DLC_DriverControls_Maxbuscurrent 8
	struct DriverControls::Maxbuscurrent {
		float Zero;
		float MaxBusCurrent;
	} __attribute__((aligned(8)));
	#endif
...
#define CAN_DLC_Tritium_IdentificationInfo 8
	struct Tritium::IdentificationInfo {
		uint32_t TritiumId;
...
#define CAN_DLC_Tritium_StausInformation 8
	struct Tritium::StausInformation {
		uint16_t LimitFlags;
		uint16_t ErrorFlags;
...
#define CAN_DLC_Tritium_MotorVoltageVector 8
	struct Tritium::MotorVoltageVector {
		float VectVoltImag;
		float VectVoltReal;
	} __attribute__((aligned(8)));
	#endif
...
#define CAN_DLC_Tritium_MotorCurrentVector 8
	struct Tritium::MotorCurrentVector {
		float VectCurrImag;
		float VectCurrReal;
	} __attribute__((aligned(8)));
	#endif
...
#define CAN_DLC_Tritium_MotorBackemfVector 8
	struct Tritium::MotorBackemfVector {
...
#define CAN_DLC_Tritium_Rail_3_3VAnd1_9V 8
	struct Tritium::Rail_3_3VAnd1_9V {
...
#define CAN_DLC_Tritium_SinkMotorTemperature 8
	struct Tritium::SinkMotorTemperature {
		float MotorTemp;
		float HeatSinkTemp;
	} __attribute__((aligned(8)));
	#endif
...
#define CAN_DLC_Tritium_DspBoardTemperature 8
	struct Tritium::DspBoardTemperature {
		float DspBoardTemp;
		float Reserved;
	} __attribute__((aligned(8)));
	#endif
...
#define CAN_DLC_Tritium_SlipSpeedMeasurement 8
	struct Tritium::SlipSpeedMeasurement {
		float Reserved;
		float SlipSpeed;
	} __attribute__((aligned(8)));
	#endif
...
#define CAN_DLC_Orion_CellTempsDischargeChageCurrentLimit 7
	struct Orion::CellTempsDischargeChageCurrentLimit {
		int16_t PackDcl;
		int16_t Unknown;
...
#define CAN_DLC_Telemetry_MpptPollJaved 1
	struct Telemetry::MpptPollJaved {
		int8_t Blank;
	} __attribute__((aligned(8)));
	#endif
